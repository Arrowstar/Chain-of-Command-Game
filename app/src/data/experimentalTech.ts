...
export const EXPERIMENTAL_TECH: ExperimentalTech[] = [
  ...
  },
  {
    ...
    category: 'tactical',
    effect: 'Once per combat scenario, during the Execution Phase, the War Council may declare a "Tachyon Strike." Choose one standard Hit just rolled in any Volley Pool and manually convert it into a Critical Hit (which then explodes as normal).',
  ...
  },
  {
    ...
    category: 'crew',
    effect: "At the end of the Cleanup Phase, if a player's ship took absolutely no Hull damage that round, that player may remove 1 Stress from any of their Bridge Officers.",
