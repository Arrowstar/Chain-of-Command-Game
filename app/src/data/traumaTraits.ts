...
export const TRAUMA_POOL: TraumaEffect[] = [
  ...
  { id: 'insubordinate', name: 'Insubordinate', effect: 'If the War Council chooses not to override the Admiral\'s RoE, this officer gains +1 Stress every round during the Briefing Phase.' },
  ...
  // Helm
  { id: 'claustrophobic', name: 'Claustrophobic', effect: 'If the ship ends the Execution Phase adjacent to an Asteroid Field or Debris Field, this officer gains +2 Stress.' },
  ...
  { id: 'trigger-happy', name: 'Trigger Happy', effect: 'If this officer does not execute a "Fire Primary" action during a combat round, they gain +2 Stress during the Cleanup Phase.' },
  ...
  { id: 'phantom-scanners', name: 'Phantom Scanners', effect: 'At the start of the Briefing Phase, roll a D6. On a 1 or 2, this officer gains +1 Stress immediately.' }
];
