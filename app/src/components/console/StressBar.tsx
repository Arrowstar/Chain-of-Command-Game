...
export default function StressBar({ currentStress, maxStress, officerName }: StressBarProps) {
  if (maxStress === null) {
    return (
      <SmartTooltip content={`${officerName}: Immune to Stress`} as="div">
  ...
  return (
    <SmartTooltip content={`${currentStress} / ${maxStress} Stress`} as="div">
      <div className="stress-bar" data-testid={`stress-bar-${officerName}`}>
