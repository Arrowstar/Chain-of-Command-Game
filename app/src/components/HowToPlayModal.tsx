        ...
        return (
          <div className="animate-fadeIn">
            ...
            <ul>
              ...
              <li><strong>Ion Nebula:</strong> +1 TN for attacks against the occupant. Blocks Line of Sight. Electrostatic interference disables all shields while inside (treated as 0). Conceals enemy ship identity — they appear as ghost contacts (diamond "?" markers) until Identified by Target Lock or revealed by proximity (≤1 hex) or opening fire. Firing at an unidentified ghost contact applies an additional +3 TN penalty (total +4 with terrain).</li>
